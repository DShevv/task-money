  ...
  return (
    <Container style={{ gap: "16px" }}>
      ...
      <TextUnit>
        ...
        будут доступны 5 заданий в день, оплата за задачу 0,75 Т. Заработок
        составит 3,757 в день, 112,5 Т в месяц или 1368,75 Т в год.
      </TextUnit>
      <TextUnit>
        3. Внесите депозит в размере 400 USDT, чтобы стать VIP 2. На этом
        статусе доступны 8 заданий заданий в день, оплата за задачу 1,32 Т.
        Заработок составит 10,56 Т в день, 316,8 Т в месяц или 3854,4 Т в год.
      </TextUnit>
      <TextUnit>
        4. Внесите депозит в размере 1250 USDT, чтобы стать VIP 3. На этом
        статусе доступны 18 заданий в день, 1,93 Т за задачу, 3,75 Т в день,
        1042,2 Т в месяц или 12 680,1 Т в год.
      </TextUnit>
      <TextUnit>
        5. Внесите депозит в размере 2500 USDT, чтобы стать VIP 4. На этом
        статусе доступны 30 заданий в день, 2,45 Т за задачу, 73,5 Т в день,
        2205 Т в месяц или 26 827,5 Т в год.
      </TextUnit>
      <TextUnit>
        6. Внесите депозит в размере 5000 USDT, чтобы стать VIP 5. На этом
        статусе доступны 55 заданий в день, 2,84 Т за задачу, 156,2 Т в день,
        4686 Т в месяц или 57 013,7 Т в год.
      </TextUnit>
      <TextUnit>
        ...
        Т. Заработок составит 333,2 1 в день, 9996 Т в месяц или 121 618 Т в
        год.
      </TextUnit>
    </Container>
  );
